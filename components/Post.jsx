            ...
            <div className="px-3">
                <a href="#" className="flex p-1 pb-0">
                    ...
                    <div className="flex justify-between w-full">
                        <h1 className="ml-2 mt-1 text-white font-bold leading-1">User</h1>       
            ...
            <div>
                <div className="flex justify-between p-3">
                    ...
                    <div className="text-sm text-gray-400">
                        <button className="cursor-pointer m-0 p-0 hover:underline" onClick={() => setCommentsShown(!commentsShown)}>3 comments </button>
                        <a href="#" className="m-2 hover:underline">4 shares</a>
                    </div>
                </div>
                ...
                <div className={commentsShown ? "flex" : "hidden"}>
                    <div className="flex flex-col px-3">
                        <div className="mt-3 mb-1 flex">
                            <img src="https://picsum.photos/35" className="h-8 w-8 rounded-full" />
                            <input type="text" placeholder="Comment..." className="text-white rounded-xl bg-gray-700 mx-1 px-2 focus:outline-none"/>
                        </div>
                        <Comment />
                        <Comment />
                    </div>
